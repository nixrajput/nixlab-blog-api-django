    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type',
                 models.CharField(blank=True, default='public', max_length=10, verbose_name='Account Type')),
                ...
                ('followers',
                 models.ManyToManyField(blank=True, related_name='account_followers', to=settings.AUTH_USER_MODEL,
                                        verbose_name='Followers')),
                ('following',
                 models.ManyToManyField(blank=True, related_name='account_following', to=settings.AUTH_USER_MODEL,
